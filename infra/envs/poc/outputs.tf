...
output "api_gateway_api_id" {
  description = "ID of the multi-env API Gateway HTTP API."
  value       = module.api_gateway.api_id
}

output "api_gateway_invoke_url_staging" {
  description = "Invoke URL for the staging stage."
  value       = module.api_gateway.invoke_urls["staging"]
}

output "api_gateway_invoke_url_prod" {
  description = "Invoke URL for the prod stage."
  value       = module.api_gateway.invoke_urls["prod"]
}

output "api_gateway_authorizer_id" {
  description = "ID of the Lambda authorizer on the HTTP API."

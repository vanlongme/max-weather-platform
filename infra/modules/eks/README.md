...
| `jenkins_role_arn` | Jenkins IRSA role granted Edit on the namespaces in `var.jenkins_access_namespaces`. Empty -> jenkins access entry omitted (phase 1). | `string` | `""` | no |

...
// Orphan deletion is configured at the seed-job step via `removeAction('DELETE')`
// in values/jenkins.yaml (controller.JCasC.configScripts.seed-job). There is no
// script-level removedJobAction in the Job DSL API.
